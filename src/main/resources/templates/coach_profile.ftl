                                ...
                                <div class="tabbable">
                                    ...
                                    <div class="tab-content profile-edit-tab-content">
                                        <div id="edit-basic" class="tab-pane in active">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right"
                                                       for="form-field-facebook">Coach degree</label>

                                                <div class="col-sm-9">
																	<span class="input-icon">
																		<input type="text"
                                                                                value="<#if model.coach.coachDegree??>${model.coach.coachDegree}
                                                                         "</#if>name="coachDegree"
                                            ...
                                            <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right"
                                                   for="form-field-facebook">Player degree</label>

                                            <div class="col-sm-9">
																	<span class="input-icon">
																		<input type="text"
                                                                                value="<#if model.coach.playerDegree??>${model.coach.playerDegree}
                                                                         "</#if>name="playerDegree"
                                                                               id="form-field-facebook"/>
																		<i class="ace-icon fa fa-facebook blue"></i>
																	</span>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
																	<span class="input-icon">
																		<input type="text"
                                                                               value="<#if model.coach.price??>${model.coach.price}
                                                                         </#if>" name="price"
                                                                               id="form-field-facebook"/>
