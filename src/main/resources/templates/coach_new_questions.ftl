                                        ...
                                        <div class="panel-heading">
                                            <a href="#faq-1-${count}" data-parent="#faq-list-1" data-toggle="collapse"
                                               class="accordion-toggle collapsed">
                                                ...
                                                &nbsp; ${q.content} <a href="#">&nbsp; by ${q.author.user.login} </a>
                                            </a>
                                        </div>
                                        ...
                                        <div class="panel-collapse collapse" id="faq-1-${count}">
                                            <div class="panel-body">
                                                <form method="post">
                                                    ...
                                                    <div>
                                                        <label for="form-field-8">Answer content</label>

                                                        <textarea class="form-control" id="form-field-8"
                                                                  placeholder="Your answer" name="answer"></textarea>
                                                    </div>
                                                    <div class="input-group-btn">
                                                        <input type="submit"
                                                               class="btn btn-default no-border btn-sm">OK
