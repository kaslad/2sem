        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form method="post">
                    <div>
                        <label for="form-field-8">Question content</label>

                        <textarea class="form-control" id="form-field-8" placeholder="Your question" name="content"></textarea>
                    </div>
                    <div class="input-group-btn">
                        <input type="submit"
                               class="btn btn-default no-border btn-sm">ASK
